package com.larry.tools.compress;
...
/**
 * 图片压缩
 * Created by Larry on 2016/11/21 11:52.
 */
public class CompressWithLuBan {
  ...
  public static File thirdCompress(@NonNull File file) {
    ...
    String thumb = Environment.getExternalStorageDirectory().getAbsolutePath()
        + File.separator
   ...
   */
  private static File compress(String largeImagePath, String thumbFilePath, int width, int height,
      int angle, long size) {
